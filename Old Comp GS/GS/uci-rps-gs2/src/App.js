    ...
    socketRef.on("json_response", (dataString) => {
      ...
      try {
        setSensorData(prevData => ({
          ...prevData,
          temp: [...prevData.temp, parseInt(dataString?.temperature) || 0],
          pres: [...prevData.pres, parseInt(dataString?.pressure) || 0],
          alt: [...prevData.alt, parseInt(dataString?.altitude) || 0],
          acc_x_2: [...prevData.acc_x_2, parseFloat(dataString?.acceleration?.x2) || 0],
          acc_y_2: [...prevData.acc_y_2, parseFloat(dataString?.acceleration?.y2) || 0],
          acc_z_2: [...prevData.acc_z_2, parseFloat(dataString?.acceleration?.z2) || 0],
          acc_x: [...prevData.acc_x, parseFloat(dataString?.acceleration?.x) || 0],
          acc_y: [...prevData.acc_y, parseFloat(dataString?.acceleration?.y) || 0],
          acc_z: [...prevData.acc_z, parseFloat(dataString?.acceleration?.z) || 0],
          gyro_x: [...prevData.gyro_x, parseFloat(dataString?.gyro?.x) || 0],
          gyro_y: [...prevData.gyro_y, parseFloat(dataString?.gyro?.y) || 0],
          gyro_z: [...prevData.gyro_z, parseFloat(dataString?.gyro?.z) || 0],
          mag_x: [...prevData.mag_x, parseFloat(dataString?.mag?.x) || 0],
          mag_y: [...prevData.mag_y, parseFloat(dataString?.mag?.y) || 0],
          mag_z: [...prevData.mag_z, parseFloat(dataString?.mag?.z) || 0],
          voltage1: parseFloat(dataString?.voltage?.[0]) || 0,
          voltage2: parseFloat(dataString?.voltage?.[0]) || 0,
          state: [...prevData.state, 0],
          time: [...prevData.time, new Date(dataString?.timestamp).getTime() || 0]
        }));
      } catch (err) {
