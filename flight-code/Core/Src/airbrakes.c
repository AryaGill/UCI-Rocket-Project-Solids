...
float air_brakes_CdA[NUM_RECORDED_DEPLOYMENT_LEVELS][NUM_RECORDED_MACH_NUMS] = {
    ...
    // 0% deployment
    {0.009821, 0.009394, 0.0091805, 0.0091805, 0.0091805, 0.0091805, 0.0091805, 0.0091805,
     0.0091805, 0.009394, 0.009394, 0.0096075, 0.009821, 0.0100345},

    // 10% deployment
    {0.010267, 0.009840, 0.009631, 0.009631, 0.009636, 0.009645, 0.009649, 0.009654,
     0.009654, 0.009872, 0.009876, 0.010099, 0.010321, 0.010539},

    // 20% deployment
    {0.01071388, 0.01028688, 0.010082309, 0.010082309, 0.010091238, 0.010109095, 0.010118024, 0.010126953,
     0.010126953, 0.010349382, 0.01035831, 0.010589668, 0.010821026, 0.011043454},

    // 30% deployment
    {0.0111603, 0.0107333, 0.010533193, 0.010533193, 0.010546586, 0.010573372, 0.010586765, 0.010600158,
     0.010600158, 0.010827051, 0.010840444, 0.01108073, 0.011321016, 0.011547909},

    // 40% deployment
    {0.0116067, 0.0111797, 0.010984057, 0.010984057, 0.011001914, 0.011037628, 0.011055485, 0.011073342,
     0.011073342, 0.011304699, 0.011322556, 0.01157177, 0.011820984, 0.012052341},

    // 50% deployment
    {0.0120532, 0.0116262, 0.011435022, 0.011435022, 0.011457344, 0.011501988, 0.01152431, 0.011546632,
     0.011546632, 0.011782454, 0.011804776, 0.01206292, 0.012321064, 0.012556886},

    // 60% deployment
    {0.0124996, 0.0120726, 0.011885886, 0.011885886, 0.011912672, 0.011966244, 0.01199303, 0.012019816,
     0.012019816, 0.012260102, 0.012286888, 0.01255396, 0.012821032, 0.013061318},

    // 70% deployment
    {0.0129461, 0.0125191, 0.012336851, 0.012336851, 0.012368102, 0.012430604, 0.012461855, 0.012493106,
     0.012493106, 0.012737857, 0.012769108, 0.01304511, 0.013321112, 0.013565863},

    // 80% deployment
    {0.0133925, 0.0129655, 0.012787715, 0.012787715, 0.01282343, 0.01289486, 0.012930575, 0.01296629,
     0.01296629, 0.013215505, 0.01325122, 0.01353615, 0.01382108, 0.014070295},

    // 90% deployment
    {0.0138389, 0.0134119, 0.013238579, 0.013238579, 0.013278758, 0.013359116, 0.013399295, 0.013439474,
     0.013439474, 0.013693153, 0.013733332, 0.01402719, 0.014321048, 0.014574727},

    // 100% deployment
    {0.0142854, 0.0138584, 0.013689544, 0.013689544, 0.013734188, 0.013823476, 0.01386812, 0.013912764,
     0.013912764, 0.014170908, 0.014215552, 0.01451834, 0.014821128, 0.015079272}
};
